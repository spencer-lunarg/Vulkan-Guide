...
:chapters: chapters/
:extensions: chapters/extensions/
...
include::{extensions}VK_KHR_synchronization2.adoc[]

include::{extensions}cleanup.adoc[]

include::{extensions}device_groups.adoc[]

include::{extensions}external.adoc[]

include::{extensions}ray_tracing.adoc[]

include::{extensions}shader_features.adoc[]

include::{extensions}translation_layer_extensions.adoc[]

include::{extensions}VK_EXT_descriptor_indexing.adoc[]

include::{extensions}VK_EXT_inline_uniform_block.adoc[]

include::{extensions}VK_EXT_memory_priority.adoc[]

include::{extensions}VK_KHR_descriptor_update_template.adoc[]

include::{extensions}VK_KHR_draw_indirect_count.adoc[]

include::{extensions}VK_KHR_image_format_list.adoc[]

include::{extensions}VK_KHR_imageless_framebuffer.adoc[]

include::{extensions}VK_KHR_sampler_ycbcr_conversion.adoc[]

include::{extensions}VK_KHR_shader_subgroup_uniform_control_flow.adoc[]

include::{extensions}VK_KHR_debug_utils.adoc[]
